...
public class FavouriteBookDao_Impl(
  ...
  public override fun getFavouriteBooks(): Flow<List<FullBookDetails>> {
    ...
    return createFlow(__db, true, arrayOf("BookLanguageCrossRef", "language_table",
      ...
      try {
        ...
        val _collectionLanguages: MutableMap<String, MutableList<LanguageEntity>> = mutableMapOf()
        val _collectionAuthors: MutableMap<String, MutableList<AuthorEntity>> = mutableMapOf()
        while (_stmt.step()) {
          val _tmpKey: String
  ...
  private
      ...
      _map: MutableMap<String, MutableList<LanguageEntity>>) {
  ...
  private
      ...
      _map: MutableMap<String, MutableList<AuthorEntity>>) {
    val __mapKeySet: Set<String> = _map.keys
    if (__mapKeySet.isEmpty()) {
      return
    }
